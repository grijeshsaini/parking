...
public class UtilTest {
	...
	public void should_return_vehicle_details(){
		List<Vehicle> vehicles = Collections.singletonList(new Vehicle.Builder().colour("blue").make("audi").reg("1234").build());

		List<VehicleDetails> vehicleDetails = Collections.singletonList(new VehicleDetails.Builder().colour("blue").make("audi").regNo("1234").build());
	...
	public void should_return_parking_details(){
		...
		List<VehicleDetails> vehicleDetails = Collections.singletonList(new VehicleDetails.Builder().colour("blue").
				make("audi").regNo("1234").build());
		...
		assertEquals(parkingDetails.getVehicles().get(0).getColour(), Util.buildParkingDetails(parking).getVehicles().get(0).getColour());
